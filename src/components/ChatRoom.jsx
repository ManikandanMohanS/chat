        ...
        {messages.map((msg, idx) => {
          ...
          return (
            <div
              ...
              style={{ marginTop: showAvatar ? "1rem" : "0.3rem", marginBottom: "0.25rem" }}
                ...
                <div className="d-flex flex-column align-items-start">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: isMe ? "linear-gradient(to right, #ff00cc, #333399)" : "#2c3e50",
                      color: "white",
                      borderRadius: "20px",
      ...
      >
        {showEmojiPicker && (
          <div className="mb-2 position-absolute" style={{ bottom: "60px", zIndex: 15 }}>
            <EmojiPicker theme="dark" onEmojiClick={(e) => setMessage((prev) => prev + e.emoji)} />
          </div>
        )}
        <div className="d-flex align-items-center rounded-pill px-3" style={{ background: "#1c1c1c", border: "1px solid #444" }}>
          <button className="btn btn-sm text-white" onClick={() => setShowEmojiPicker((prev) => !prev)}>
            <FaSmile />
          </button>
          <input
            type="text"
